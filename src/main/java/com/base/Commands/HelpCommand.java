...
public class HelpCommand extends Command {
    public String[] helpControls = {"\tTo create new note use command: \n\t\tCreate [1, if Health or 2, if Study] [Content that you want to put in your note]",
            ...
            "\tTo print one note encoded in Base64 use command: \n\t\tPrintB64 [1, if from Health or 2, if from Study] [ID of the note]",
            "\tTo set note's status to DONE : \n\t\tDone [1, if from Health or 2, if from Study] [ID of the note]",
